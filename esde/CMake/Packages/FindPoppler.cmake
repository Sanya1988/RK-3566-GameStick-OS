...
if( NOT(POPPLER_LIBRARY) )
  ...
  # This upstream module assumes a native build and shells out to ldd.
  # For Buildroot cross-builds that fails on target ELF binaries, and the
  # result is only used as optional metadata, so skip the probe there.
