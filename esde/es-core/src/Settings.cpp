...
void Settings::setDefaults()
{
    ...
    mStringMap["RandomEntryButton"] = {"disabled", "disabled"};

    // UI settings -> system status settings.
    mBoolMap["SystemStatusBluetooth"] = {false, false};
    mBoolMap["SystemStatusWifi"] = {false, false};
    mBoolMap["SystemStatusCellular"] = {false, false};
    ...
    mIntMap["SoundVolumeBackgroundMusic"] = {60, 60};
    mIntMap["SoundVolumeVideos"] = {80, 80};
    mBoolMap["BackgroundMusic"] = {true, true};
    ...
    mStringMap["BackgroundMusicDirectory"] = {"/storage/music", "/storage/music"};

    // Input device settings.
    mStringMap["InputControllerType"] = {"ps123", "ps123"};
...
#endif
#if !defined(__IOS__)
    mBoolMap["CustomEventScripts"] = {true, true};
