...
Данная сборка представляет собой версию `GameStick OS`для Stick Game M16 4K Ultra HD (Gold Stick) и представлять собой полностью собранную с нуля ОС на базе buildroot. В качестве фронтэнда используется связка EmulationStation Desktop Edition (ES-DE) и Retroarch.

Из существенных доработок можно отметить проигрывание музыки в главном меню и полное меню Retroarch. Все сетевые функции убраны. Добавлена поддержка сторонних геймпадов. Более подробная инструкция по использованию прилагается.
